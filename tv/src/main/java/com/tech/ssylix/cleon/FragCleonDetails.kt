 ...
 */
class FragCleonDetails : DetailsSupportFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSelectedMovie = activity!!.intent.getSerializableExtra(CleonDetails.MOVIE) as Movie
        if (mSelectedMovie != null) {
            ...
            val intent = Intent(activity, CleonTV::class.java)
    ...
    private fun setupDetailsOverviewRowPresenter() {
        ...
        sharedElementHelper.setSharedElementEnterTransition(
            activity, CleonDetails.SHARED_ELEMENT_NAME
        )
        ...
        detailsPresenter.onActionClickedListener = OnActionClickedListener { action ->
            if (action.id == ACTION_WATCH_TRAILER) {
                ...
                intent.putExtra(CleonDetails.MOVIE, mSelectedMovie)
                startActivity(intent)
            } else {
    ...
    private inner class ItemViewClickedListener : OnItemViewClickedListener {
        override fun onItemClicked(
            ...
            if (item is Movie) {
                ...
                val intent = Intent(activity, CleonDetails::class.java)
                ...
                val bundle =
                    ActivityOptionsCompat.makeSceneTransitionAnimation(
                        ...
                        CleonDetails.SHARED_ELEMENT_NAME
                    )
                        .toBundle()
    ...
    companion object {
        private val TAG = "Frag.CleonDetails"
